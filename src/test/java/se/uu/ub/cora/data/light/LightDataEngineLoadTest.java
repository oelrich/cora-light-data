...
public class LightDataEngineLoadTest {
	...
	private List<String> getFilesForCollection(String collection) {
		return Objects.requireNonNull(getResourceFiles())
			.stream()
	...
	private void addFileCollection(String file,
			Map<String, Map<String, Set<JSONObject>>> fileCollections) {
		var fileJson = readJsonResource(file);

		var collectionName = Objects.requireNonNull(fileJson)
			.getString(NAME);
